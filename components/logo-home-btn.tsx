        ...
        <li>
            <a href="/" className="flex items-center pl-2.5 mb-5 justify-center">
                ...
                <div className='flex flex-col'>
                    ...
                    <div className='flex justify-evenly self-center bg-[#797E88]'><span className=' text-center pt-1 px-2 text-[#B1B0C0] text-sm tracking-widest'>Full-Stack Software Engineer</span></div>
                </div>
            </a>
        </li>
    )
