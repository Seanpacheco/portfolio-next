              ...
              <div className="flex-1">
                <a href="/" className="flex items-center pl-2.5 justify-center">
                  ...
                  <div className='flex flex-col'>
                    ...
                    <div className='flex justify-center self-center bg-[#797E88]'><div className=' text-center text-[#B1B0C0] text-sm tracking-widest'>Full-Stack Software Engineer</div></div>
                  </div>
                </a>
              </div>
